...
var _user$project$WeatherApp$precipIconName = function (text) {
	var _p0 = text;
	switch (_p0) {
		case 'snow':
			return 'snow';
...
var _user$project$WeatherApp$precipIcon = F2(
	function (text, pc) {
		var iconName = _user$project$WeatherApp$precipIconName(text);
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$i,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							A2(_elm_lang$core$Basics_ops['++'], 'wi wi-fw wi-', iconName)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('precip-bar'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('precip-percent'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'width',
													_1: A2(_elm_lang$core$Basics_ops['++'], pc, '%')
												},
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
...
var _user$project$WeatherApp$precipView = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('precip'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_user$project$WeatherApp$precipIcon,
				data.precipType,
...
var _user$project$WeatherApp$maxTempView = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('temp-max'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$WeatherApp$minTempView = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('temp-min'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$WeatherApp$currentTempView = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('temp-current'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$WeatherApp$tempView = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('temperatures'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$WeatherApp$currentTempView(data),
			_1: {
				ctor: '::',
				_0: _user$project$WeatherApp$maxTempView(data),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('sep'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _user$project$WeatherApp$minTempView(data),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$WeatherApp$dayView = F2(
	function (pos, data) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$WeatherApp$iconView(data),
				_1: {
					ctor: '::',
					_0: _user$project$WeatherApp$tempView(data),
					_1: {
						ctor: '::',
						_0: _user$project$WeatherApp$precipView(data),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$WeatherApp$FetchResponse = function (a) {
	return {ctor: 'FetchResponse', _0: a};
};
var _user$project$WeatherApp$getWeather = A2(
	_elm_lang$http$Http$send,
	_user$project$WeatherApp$FetchResponse,
	A2(_elm_lang$http$Http$get, '/api/weather', _user$project$WeatherApp$decodeWeather));
...
var _user$project$WeatherApp$main = _elm_lang$html$Html$program(
...
if (typeof _user$project$WeatherApp$main !== 'undefined') {
    _user$project$WeatherApp$main(Elm['WeatherApp'], 'WeatherApp', undefined);
}
